...
# Reading oracle database and parsing into pandas data frame

connection = cx_Oracle.connect('system', 'sytempwds', 'localhost:1521/XE')
with connection:
    try:
        file = pandas.read_sql_query(Select * from finaltable)

#file =  pandas.read_csv("/home/tarun/Downloads/final.csv") if we want to read from a flat csv file.
